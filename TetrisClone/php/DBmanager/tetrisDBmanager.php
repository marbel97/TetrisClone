<?php
    ...
    require_once DBMAN_DIR . "dbConfig.php";		// includes database class
    $tetris = new tetrisDBManager(); // creates a new istance of Database Class

	class tetrisDBManager {
		private $mysqli_conn = null;
	
		function tetrisDBManager(){
			$this->openConnection();
		}
